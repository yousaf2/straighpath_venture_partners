    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <form action="{{url('companies/update')}}" method="POST" novalidate enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" id="cid" value="{{$company->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @if($errors->has('location')) is-invalid @endif"
                                       ...
                                       value="{{ $company->location ?? old('location')}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control @if($errors->has('revenue')) is-invalid @endif"
                                       ...
                                       value="{{ $company->revenue ?? old('revenue')}}"/>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" cols="10" rows="5" name="description" id="description" placeholder="Enter description">
                            ...
                            <div class="form-group mb-0 text-center">
                                <button class="btn btn-success btn-block" type="submit"> Update Company</button>
                            </div>
