...
<div class="navbar-custom">
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <?php /*li class="d-none d-lg-block">
            ...
            <?php /*li class="dropdown d-none d-lg-inline-block">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect waves-light" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <?php /*img src="{{asset('assets/images/users/user-1.jpg')}}" alt="user-image" class="rounded-circle" */?>
        ...
        <div class="logo-box">
            ...
            <a href="{{route('any', ['dashboard'])}}" class="logo logo-light">
                <span class="logo-sm">
                    <img style="height: 40px; margin-left: 10px;" src="{{asset('assets/images/al.png')}}"alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img style="height: 38px; margin-left: 4px;" src="{{asset('assets/images/straightpath.png')}}"alt="" height="20">
                </span>
            </a>
        </div>
