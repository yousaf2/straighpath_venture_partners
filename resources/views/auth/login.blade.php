...
<html lang="en">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4" style="background-color:#eeeeee!important;">
                                
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="{{route('index')}}" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img style="height: 60px; margin-left: -45px;" src="{{asset('assets/images/straightpath.png')}}" alt="" height="22">
                                            </span>
                                        </a>
                                ...
                                <form action="{{route('login')}}" method="POST" novalidate class="mt-3">
                                    @csrf
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> &copy; SDS Revised
        </footer>
